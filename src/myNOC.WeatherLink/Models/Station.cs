...
namespace myNOC.WeatherLink
{
	public class Station
	{
		...
		public DateTimeOffset RegsisteredDate => DateTimeOffset.FromUnixTimeSeconds(UnixRegisteredDate ?? 0);
		[JsonPropertyName("subscription_end_date")]
		public int? UnixSubscriptionEndDate { get; set; }
		public DateTimeOffset SubscriptionEndDate => DateTimeOffset.FromUnixTimeSeconds(UnixSubscriptionEndDate ?? 0);
