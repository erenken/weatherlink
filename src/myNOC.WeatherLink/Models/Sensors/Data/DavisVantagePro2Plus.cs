...
namespace myNOC.WeatherLink.Sensors.Data
{
	public class DavisVantagePro2Plus : SensorData
	{
		...
		public int WindDirectionScalarAvgLast_10Min { get; set; }
		...
		public int WindSpeedAvgLast_10Min { get; set; }
		...
		public DateTimeOffset RainStormLastStartAt => DateTimeOffset.FromUnixTimeSeconds(UnixRainStormLastStartAt);
		...
		public DateTimeOffset RainStormLastEndAt => DateTimeOffset.FromUnixTimeSeconds(UnixRainStormLastEndAt);
		[JsonPropertyName("rain_storm_mm")]
		public float RainStorm_mm { get; set; }
		[JsonPropertyName("wind_dir_scalar_avg_last_2_min")]
		public int WindDirectionScalarAvgLast_2Min { get; set; }
		...
		public DateTimeOffset RainStormStartTime => DateTimeOffset.FromUnixTimeSeconds(UnixRainStormStartTime);
		...
		public int WindDirScalarAvgLast_1Min { get; set; }
		[JsonPropertyName("temp")]
		public float Temperature { get; set; }
		[JsonPropertyName("wind_speed_avg_last_2_min")]
		public int WindSpeedAvgLast_2Min { get; set; }
		...
		public int WindSpeedAvgLast_1Min { get; set; }
